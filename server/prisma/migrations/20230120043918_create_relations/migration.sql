...
INSERT INTO "new_habit_week_days" ("habit_id", "id", "weed_day") SELECT "habit_id", "id", "weed_day" FROM "habit_week_days";
DROP TABLE "habit_week_days";
ALTER TABLE "new_habit_week_days" RENAME TO "habit_week_days";
CREATE UNIQUE INDEX "habit_week_days_habit_id_weed_day_key" ON "habit_week_days"("habit_id", "weed_day");
